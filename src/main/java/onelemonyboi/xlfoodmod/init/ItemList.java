...
// Salads
	...
	public static final RegistryObject<Item> LEMON_SYRUP = ITEMS.register("lemon_syrup", () -> new JuiceItem(2, 0.2f));
	public static final RegistryObject<Item> STRAWBERRY_SYRUP = ITEMS.register("strawberry_syrup", () -> new JuiceItem(2, 0.2f));
	public static final RegistryObject<Item> PINEAPPLE_SYRUP = ITEMS.register("pineapple_syrup", () -> new JuiceItem(2, 0.2f));
