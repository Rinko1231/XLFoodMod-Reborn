...
public class PlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> VANILLA_FLOWERY_PLACED = registerKey("vanilla_flowery_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, ROCK_SALT_PLACED, configuredFeatures.getOrThrow(ConfiguredFeatures.ROCK_SALT_KEY),
                commonOrePlacement(7, // VeinsPerChunk
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(64), VerticalAnchor.aboveBottom(100))));
    }
